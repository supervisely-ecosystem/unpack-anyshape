...
**Second option**: Create class **car** with shape **AnyShape**. It means that you can use all annotation instruments to label objects. The main drawback: your labeling team have to understand annotation requirements well. For example, labelers are not restricted to specific annotation instrument, you expect polygons but they label objects with rectangles. `¯\_(ツ)_/¯`
